...
export const env: Env = Object.freeze({
  ...
  E2E_PASSWORDLESS_TOKEN: optional(process.env.E2E_PASSWORDLESS_TOKEN),
  ...
  SFCC_CLIENT_SECRET: optional(process.env.SFCC_CLIENT_SECRET),
