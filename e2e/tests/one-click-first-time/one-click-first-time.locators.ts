...
export const firstNameRegistrationInput = (page: Page): Locator =>
  page.getByRole('dialog').getByRole('textbox', { name: 'First Name', exact: true });

export const lastNameRegistrationInput = (page: Page): Locator =>
...
export const savePaymentCheckbox = (page: Page): Locator =>
  page.getByRole('checkbox', { name: 'Save payment for next time', exact: true });
